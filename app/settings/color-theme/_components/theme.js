export default function Theme() {
  return (
    <label className="mt-8 w-full max-w-[528px] rounded-xl border-[1px] border-custom-neutral-200 p-4 flex justify-between items-center cursor-pointer has-[:checked]:bg-custom-neutral-100">
      ...
      <div className="w-4 h-4 rounded-full border-2 border-custom-neutral-200 peer-checked:border-blue-500 peer-checked:border-4"></div>
    </label>
  );
}
