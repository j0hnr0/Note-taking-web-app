...
export default function CreateNoteForm({ isInArchivedNotes }) {
  ...
  return (
    <form
      ...
      className="flex flex-col h-full py-5 px-6 w-full max-w-[562px] max-custom-md:max-w-full border-r-[1px] border-r-custom-neutral-200 dark:border-r-custom-neutral-800 max-custom-sm:order-first animate-slide-fade-in"
    >
      <input
        type="text"
        name="title"
